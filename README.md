# 🛍️ Yoogiscloset - 중고 의류 판매 플랫폼 통합 자동화 시스템

> **고이비토(Koibito) 상품 스크래핑**과 **유기스클로젯(Yoogi's Closet) 자동 판매 등록**을 통합한 중고 의류 판매 자동화 시스템
...
> **⚠️ 본 프로젝트는 크롤링 및 웹 자동화 기술 학습을 위한 개인 학습 프로젝트입니다.**

이 프로젝트는 **고이비토(Koibito)**에서 상품 정보를 자동으로 스크래핑하고, **유기스클로젯(Yoogi's Closet)**에 자동으로 판매 등록하는 통합 자동화 시스템입니다. 
...
- 실제 운영 환경에서 사용하기 전에 웹사이트의 이용약관 및 robots.txt를 확인하시기 바랍니다
- 과도한 요청으로 인한 서버 부하를 방지하기 위해 적절한 딜레이를 설정하시기 바랍니다
- 웹 스크래핑 시 저작권 및 개인정보 보호법을 준수해야 합니다


*이 프로젝트는 웹 크롤링 및 자동화 기술 학습을 목적으로 개발된 개인 학습 프로젝트입니다.*
